...
const LogoAnimation = () => {
  ...
  useEffect(() => {
    ...
    const strokeColor = themeName === "dark" ? "currentColor" : "#000000";
  ...
  return (
    <div className="h-screen bg-cover bg-center flex items-center justify-center">
      ...
      <svg
        ...
        className={`w-[200px] md:w-[300px] ${themeName === "dark" ? "text-white" : "text-black"}`}
      >
        <path
          ...
          fill="currentColor"
          stroke={themeName === "dark" ? "currentColor" : "#000000"}
          stroke-width="0.5"
        />
